...
namespace SchoolRegister.Services.Interfaces
{
    public interface IGroupService
    {
        ...
        SubjectVm AttachTeacherToSubject(AttachDetachSubjectToTeacherVm attachTeacherToSubjectVm);
        ...
        SubjectVm DetachTeacherFromSubject(AttachDetachSubjectToTeacherVm detachTeacherToSubjectVm);
