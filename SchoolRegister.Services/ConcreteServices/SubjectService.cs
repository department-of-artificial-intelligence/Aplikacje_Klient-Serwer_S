...
namespace SchoolRegister.Services.ConcreteServices
{
  public class SubjectService : BaseService, ISubjectService
  {
    ...
    public SubjectVm GetSubject(Expression<Func<Subject, bool>>? filterExpression = null)
    {
      try
      {
    ...
    public IEnumerable<SubjectVm> GetSubjects(Expression<Func<Subject, bool>>? filterExpression)
    {
      try
      {
