...
namespace SchoolRegister.Web.Controllers
{
    ...
    public class SubjectController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            if (_userManager.IsInRoleAsync(user, "Teacher").Result && user is Teacher teacher)
        ...
        public IActionResult AddOrEditSubject(int? id = null)
        {
            ...
            ViewBag.TeachersSelectList = new SelectList(
                teachersVm.Select(t => new { Text = t.FirstName + " " + t.LastName, Value = t.Id }),
                "Value", "Text");
        ...
        public IActionResult AddOrEditSubject(AddOrUpdateSubjectVm addOrUpdateSubjectVm)
        {
            ...
            return View(addOrUpdateSubjectVm);
        }
