    ...
    public static class Extensions
    {
        public static async void SeedData(this IServiceCollection services)
        {
            ...
            var subject4 = new Subject()
            {
                ...
                Description =
                    "Administracja Intenetowymi Systemami Baz Danych jest kontynuacją przedmiotu Bazy danych na studiach stacjonarnych Igo stopnia spec. PAI",
                TeacherId = 2,
            };
            ...
            //SubjectGroups
            var subjectGroup1 = new SubjectGroup() { SubjectId = 1, GroupId = 1 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup1);
            var subjectGroup2 = new SubjectGroup() { SubjectId = 1, GroupId = 2 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup2);
            var subjectGroup3 = new SubjectGroup() { SubjectId = 2, GroupId = 1 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup3);
            var subjectGroup4 = new SubjectGroup() { SubjectId = 2, GroupId = 2 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup4);
            var subjectGroup5 = new SubjectGroup() { SubjectId = 2, GroupId = 3 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup5);
            var subjectGroup6 = new SubjectGroup() { SubjectId = 3, GroupId = 3 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup6);
            var subjectGroup7 = new SubjectGroup() { SubjectId = 4, GroupId = 2 };
            await dbContext.SubjectGroups.AddAsync(subjectGroup7);
            var subjectGroup8 = new SubjectGroup() { SubjectId = 4, GroupId = 3 };
