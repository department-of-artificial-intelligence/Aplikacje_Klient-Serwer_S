...
public class GradeServiceUnitTests : BaseUnitTests
{
    ...
    {
        var getGradesReportForStudent = new GetGradesReportVm() { StudentId = 5, GetterUserId = 1 };
    ...
    {
        var getGradesReportForStudent = new GetGradesReportVm() { StudentId = 5, GetterUserId = 5 };
        var gradesReport = _gradeService.GetGradesReportForStudent(getGradesReportForStudent);
        Assert.NotNull(gradesReport);
    }
    ...
    {
        var getGradesReportForStudent = new GetGradesReportVm() { StudentId = 5, GetterUserId = 3 };
        var gradesReport = _gradeService.GetGradesReportForStudent(getGradesReportForStudent);
        Assert.NotNull(gradesReport);
    }
    */
